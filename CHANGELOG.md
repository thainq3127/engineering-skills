...
- [`ef0ea73`](https://github.com/mattpocock/skills/commit/ef0ea733e2458d6d5d7bd820eb500d6a6f3a2af9) - Carry an explicitly confirmed Delivery Context from specification through composed review and synthesis.

  - `to-spec` now confirms product stage, current objective, critical journeys, release gate, operating envelope, explicit non-goals, and testing seams before publishing.
  - `review-composer` freezes that approved context into the review contract and child prompts without asking for duplicate confirmation.
  - `review-synthesizer` separates technical severity from delivery priority, proposes product-aware dispositions, preserves deferred risks with revisit triggers, and requires explicit approval of the evaluated finding register before creating follow-up work.

- [`f4583df`](https://github.com/mattpocock/skills/commit/f4583df2ddcb6d742971d7941b01c5f191d3e054) - Make Project-driven skill loading the default ChatGPT Web runtime.
...
- [`f3f381b`](https://github.com/mattpocock/skills/commit/f3f381b2c0a2cc4368d7eb3a5a3f2f74d4831db6) - Split cumulative review orchestration into two explicit roles.
...
- [`d4e50c4`](https://github.com/mattpocock/skills/commit/d4e50c4d9add09b5f2b6d0bbf74cbfb4ce08a6e2) - Add a Codex-owned `/workstream-bootstrap` flow that interviews for a durable objective and completion conditions, provisions one root Issue, branch, worktree, and Project item through Workstream Tracking, leaves the new Workstream unassigned, and emits ready-to-paste ChatGPT Project instructions.

- [`b869919`](https://github.com/mattpocock/skills/commit/b869919bedc1709d70b4734939ced195d4e5bb1e) - Add a shared Workstream control-plane protocol for GitHub MCP, Projects v2, one persistent local worktree, durable handoffs between ChatGPT Web, Codex, and humans, and a Review Composer swarm with bounded delegated review leases.
...
- [`8158611`](https://github.com/mattpocock/skills/commit/81586110732c6c5d6e2d4c06cf5f98faaa6edf16) - Make review marker validation robust to GitHub transports that sanitize HTML comments.
